...
let browser = function() {
  "use strict"; let e = {
    name: null, version: null, os: null, osVersion: null, touch: null, mobile: null, _canUse: null, canUse: function(n) {
      ...
      let o = e._canUse.style, r = n.charAt(0).toUpperCase() + n.slice(1);
      ...
      r = [["ios", /([0-9_]+) like Mac OS X/, function(e) {
        ...
        return 0; 
      }], ["wp", /Windows Phone ([0-9.]+)/, null], ["android", /Android ([0-9.]+)/, null], 
      ["mac", /Macintosh.+Mac OS X ([0-9_]+)/, function(e) {
        return e.replace("_", ".").replace("_", "");
      }], ["windows", /Windows NT ([0-9.]+)/, null], ["bb", /BlackBerry.+Version\/([0-9.]+)/, null], 
      ["bb", /BB[0-9]+.+Version\/([0-9.]+)/, null], ["linux", /Linux/, null], ["bsd", /BSD/, null], ["unix", /X11/, null]], 
      i = 0; i < r.length; i++)
        if (t.match(r[i][1])) {
